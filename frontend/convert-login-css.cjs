const fs = require('fs');
let wxss = fs.readFileSync('e:/Desktop/MSMelodio/Melodio-CP/claudeio_frontend/pages/login/login.wxss', 'utf8');
...
fs.writeFileSync('e:/Desktop/MSMelodio/Melodio-CP/MS/frontend/src/views/login/Login.css', wxss);
